...
This directory contains all documentation for the Hand & Foot Flutter game.
...
- [CONTRIBUTING.md](../CONTRIBUTING.md) - How to contribute (setup, PR process, quality checks)
